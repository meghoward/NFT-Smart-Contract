...
contract MintingTicket is Test {
    ...
    function setUp() public {
        vm.prank(alice);
        ticketNFT = new TicketNFT(totalTickets, eventName, price_, alice, tokenAddress, _eventCreator);
    }
    ...
    function testExpiredTicketCannotBeUsed() public {
        ...
        vm.warp(block.timestamp + (11*86400)); // Simulate time passing beyond expiration
